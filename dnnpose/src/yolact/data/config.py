...
custom_dataset = dataset_base.copy({
    ...
    'train_images': '/content/drive/MyDrive/custom_training/',
    'train_info':   '/content/drive/MyDrive/custom_training/annotations.json',

    'valid_images': '/content/drive/MyDrive/custom_validation/',
    'valid_info':   '/content/drive/MyDrive/custom_validation/annotations.json',
...
yolact_base_config = coco_base_config.copy({
    ...
    # Training params
    'lr_steps': (7000, 15000, 17500, 18750), # (280000, 600000, 700000, 750000),
